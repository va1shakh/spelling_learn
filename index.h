...
<html lang="en">
  ...
  <body class="bg-black relative text-white">
    ...
    <script>
      ...
      // Global state without a default word list – words will come solely from word.txt.
      const state = {
        step: 0,
        input: "",
        error: false,
